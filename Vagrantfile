...
Vagrant.configure("2") do |config|
    config.vm.define :guest do |guest_config|
            ...
            guest_config.vm.network :private_network, ip: "192.168.20.32"
            ...
            guest_config.vm.hostname = "centos7.app.test"

            guest_config.vm.synced_folder "./","/var/www/local.app.test", {:mount_options => ['dmode=777','fmode=777']}
